...
export class DefaultSchemas1695283280942 implements MigrationInterface {
    name = 'DefaultSchemas1695283280942'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pricing" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "timeId" character varying, "carId" uuid, "price" character varying, "userId" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_4f6e9c88033106a989aa7ce9dee" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "drivers" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "firstName" character varying, "lastName" character varying, "dateOfBirth" date, "countryId" character varying, "phoneNo" character varying, "image" text, "hourlyRate" character varying, "userId" uuid, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_92ab3fb69e566d3eb0cae896047" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "cars" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid, "brandId" character varying, "modelId" character varying, "yearId" character varying, "colorId" character varying, "transmissionId" character varying, "carTypeId" character varying, "baggageOptionId" character varying, "seatsCapacityId" character varying, "mileage" character varying, "chassyNo" character varying, "numberPlate" character varying, "securityAmount" character varying, "description" character varying, "latitude" integer, "longitude" integer, "pickUpLocation" character varying, "dropOffLocation" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_fc218aa84e79b477d55322271b6" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "booking" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid, "carId" uuid, "packagesId" character varying, "driverId" uuid, "pickupDate" TIMESTAMP, "dropoffDate" TIMESTAMP, "pickupTime" character varying, "dropoffTime" character varying, "bookingStatus" character varying NOT NULL DEFAULT 'booked', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_49171efc69702ed84c812f33540" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "country" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "countryName" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_d170c76512626b32fbe1673305d" UNIQUE ("countryName"), CONSTRAINT "PK_bf6e37c231c4f4ea56dcd887269" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "drivers_car_cars" ("driversId" uuid NOT NULL, "carsId" uuid NOT NULL, CONSTRAINT "PK_43dde1215eaf165b939a7e96049" PRIMARY KEY ("driversId", "carsId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_6775ad2bde347ae86384e46ae9" ON "drivers_car_cars" ("driversId") `);
        await queryRunner.query(`CREATE INDEX "IDX_8d9b1bc92885e8133c1b082544" ON "drivers_car_cars" ("carsId") `);
        ...
        await queryRunner.query(`ALTER TABLE "drivers_car_cars" ADD CONSTRAINT "FK_6775ad2bde347ae86384e46ae92" FOREIGN KEY ("driversId") REFERENCES "drivers"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "drivers_car_cars" ADD CONSTRAINT "FK_8d9b1bc92885e8133c1b0825440" FOREIGN KEY ("carsId") REFERENCES "cars"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "drivers_car_cars" DROP CONSTRAINT "FK_8d9b1bc92885e8133c1b0825440"`);
        await queryRunner.query(`ALTER TABLE "drivers_car_cars" DROP CONSTRAINT "FK_6775ad2bde347ae86384e46ae92"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_8d9b1bc92885e8133c1b082544"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_6775ad2bde347ae86384e46ae9"`);
        await queryRunner.query(`DROP TABLE "drivers_car_cars"`);
