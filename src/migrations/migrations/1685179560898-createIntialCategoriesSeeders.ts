...
export class createIntialCategoriesSeeders1685179560898 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void>
  {
    ...
    await queryRunner.query("INSERT INTO categories (categoryName) VALUES('Wireless')");
    ...
    await queryRunner.query("INSERT INTO categories (categoryName) VALUES('Financial Advisory and Money Management')");
    ...
    await queryRunner.query("INSERT INTO categories (categoryName) VALUES('Hotels and Motels ')");
    await queryRunner.query("INSERT INTO categories (categoryName) VALUES('Internet Service Providers ')");
    ...
    await queryRunner.query("INSERT INTO categories (categoryName) VALUES('Meal Delivery Services')");
