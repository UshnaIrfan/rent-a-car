...
@Module({
  imports: [TypeOrmModule.forFeature([UserVerificationDocuments,UserDocuments,driver,driverOption,seatsCapacity,baggageOption,transmission,carType,color,year,carModel,brand,booking,User,car]),
