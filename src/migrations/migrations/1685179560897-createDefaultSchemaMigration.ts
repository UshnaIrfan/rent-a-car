...
export class createDefaultSchemaMigration1685179560897 implements MigrationInterface {
  name = 'createDefaultSchemaMigration1685179560897'
    ...
    public async up(queryRunner: QueryRunner): Promise<void>
    {
        ...
        await queryRunner.query(`CREATE TABLE users (id varchar(36) NOT NULL UNIQUE DEFAULT (uuid()),name varchar(255) NOT NULL, username varchar(255) NOT NULL,email varchar(255) NOT NULL, password varchar(255) NOT NULL, roles varchar(255) NULL DEFAULT 'L2A_USER',status enum('active', 'inactive') NOT NULL DEFAULT 'inactive',blockStatus enum('block', 'unblock') NOT NULL DEFAULT 'unblock', createdAt datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), updatedAt datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX IDX_fe0bb3f6520ee0469504521e71 (username), UNIQUE INDEX IDX_97672ac88f789774dd47f7c8be (email),PRIMARY KEY (id)) ENGINE=InnoDB AUTO_INCREMENT=1`);
        await queryRunner.query(`CREATE TABLE review (id varchar(36) NOT NULL UNIQUE DEFAULT (uuid()),sellerId varchar(255) NOT NULL, titleId varchar(255) NULL,titleSlug varchar(255) NULL, message longtext NULL, userId varchar(255) NOT NULL,approvedByAdmin tinyint NOT NULL,bestWriter tinyint NOT NULL, createdAt datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),updatedAt datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),PRIMARY KEY (id)) ENGINE=InnoDB AUTO_INCREMENT=1`);
