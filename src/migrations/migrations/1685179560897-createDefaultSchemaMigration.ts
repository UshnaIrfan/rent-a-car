...
export class createDefaultSchemaMigration1685179560897 implements MigrationInterface {
  name = 'createDefaultSchemaMigration1685179560897'
    ...
    public async up(queryRunner: QueryRunner): Promise<void>
    {
        ...
        await queryRunner.query(`CREATE TABLE sellers (id varchar(36) NOT NULL UNIQUE DEFAULT (uuid()), sellerName varchar(255) NULL, sellerUrl varchar(255) NULL, approvedByAdmin enum ('pending', 'approved', 'rejected') NOT NULL DEFAULT 'pending', type enum ('National & Regional Online, U.S. (Default)', 'For U.S. Locals Only!', 'Outside the U.S.', 'B2B') NOT NULL DEFAULT 'National & Regional Online, U.S. (Default)', country varchar(255) NULL, city varchar(255) NULL, state  varchar(255) NULL,  isListing  tinyint NOT NULL, createdAt datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), updatedAt datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX IDX_8e4d37f39078d9eab65cc9816b (sellerName), UNIQUE INDEX IDX_879ac4347c0fb621f2777f8196 (sellerUrl), PRIMARY KEY (id)) ENGINE=InnoDB AUTO_INCREMENT=1`);
